...
local function QPDG_fake_script() -- ImageButton.LocalScript 
...
coroutine.wrap(QPDG_fake_script)()
local function KEHEQM_fake_script() -- ImageButton.LocalScript 
	local script = Instance.new('LocalScript', ImageButton)

	script.Parent.MouseButton1Click:Connect(function  ()
		game:GetService("CoreGui").RobloxGui.Modules.Logger.libs.Enabled = not game:GetService("CoreGui").RobloxGui.Modules.Logger.libs.Enabled
	end)
end
coroutine.wrap(KEHEQM_fake_script)()
